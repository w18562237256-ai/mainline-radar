...
const researchThemes = [
  {
    ...
    leadRank: [{ rank: "龙一", name: "中际旭创", role: "容量趋势" }, { rank: "龙二", name: "新易盛", role: "容量趋势" }],
  ...
  },
  {
    ...
    leadRank: [{ rank: "龙一", name: "北方华创", role: "设备中军" }, { rank: "龙二", name: "中微公司", role: "设备中军" }],
  ...
  },
  {
    ...
    leadRank: [{ rank: "龙一", name: "长城军工", role: "情绪先锋" }, { rank: "龙二", name: "建设工业", role: "趋势助攻" }],
  ...
  },
  {
    ...
    leadRank: [{ rank: "龙一", name: "中国西电", role: "容量中军" }, { rank: "龙二", name: "双杰电气", role: "弹性核心" }],
  ...
  },
  {
    ...
    leadRank: [{ rank: "龙一", name: "中国卫星", role: "容量核心" }, { rank: "龙二", name: "中国卫通", role: "容量核心" }],
  ...
  },
  {
    ...
    leadRank: [{ rank: "龙一", name: "恒瑞医药", role: "容量中军" }, { rank: "龙二", name: "三生国健", role: "趋势核心" }],
  ...
  },
  {
    ...
    leadRank: [{ rank: "龙一", name: "孚日股份", role: "情绪先锋" }, { rank: "龙二", name: "日科化学", role: "弹性助攻" }],
